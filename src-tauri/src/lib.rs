...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::portfolio::holding_list,
            commands::portfolio::portfolio_summary,
            commands::portfolio::holding_save,
            commands::portfolio::holding_set_price,
            commands::portfolio::holding_delete,
            commands::portfolio::quote_fetch,
            commands::feed::feed_catalog,
            commands::feed::feed_source_list,
            commands::feed::feed_source_add,
            commands::feed::feed_source_set_enabled,
            commands::feed::feed_source_delete,
            commands::feed::feed_item_list,
            commands::feed::feed_item_mark_read,
            commands::feed::feed_mark_all_read,
            commands::feed::feed_item_open,
            commands::feed::feed_refresh,
            ...
            commands::notes::note_image_add,
            commands::notes::note_image_list,
            commands::notes::note_image_data,
